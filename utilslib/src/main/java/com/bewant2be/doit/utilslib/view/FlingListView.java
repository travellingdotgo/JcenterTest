package com.bewant2be.doit.utilslib.view;
...
import com.bewant2be.doit.utilslib.R;

/**
 * Created by user on 4/23/17.
 */

public class FlingListView extends ListView implements View.OnTouchListener,
